...
def test_sparta_fc():
    """Test scraping Sparta F. C. specifically"""
    scraper = HorseProfileScraper()
    
    print("Testing Sparta F. C. scraping...")
    result = scraper.scrape_horse_profile("Sparta F. C.")
    ...
    if result:
        ...
        print("No result found for Sparta F. C.")
