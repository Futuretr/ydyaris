#!/usr/bin/env python3
"""
Test Cashed specifically with _1 variant
"""
...
def test_cashed():
    """Test scraping Cashed specifically"""
    scraper = HorseProfileScraper()
    
    print("Testing Cashed scraping with _1 variant...")
    result = scraper.scrape_horse_profile("Cashed")
    ...
    if result:
        ...
        print("No result found for Cashed")
